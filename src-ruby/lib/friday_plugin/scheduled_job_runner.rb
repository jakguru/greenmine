module FridayPlugin
  module ScheduledJobRunner
    TASK_NAME = "tasks_every_minute"
    ...
    def self.run_if_needed
      ...
      if tracker.last_run_at.nil? || tracker.last_run_at < 1.minute.ago
    ...
    def self.run_periodic_task
      ...
      StripStartAndDueDatesFromBacklogJob.perform_async
    rescue => e
