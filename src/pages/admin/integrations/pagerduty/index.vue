<template>
  <QueriesPage
    :title="$t('pages.admin-integrations-pagerduty.title')"
    :params="params"
    :payload="payload"
    :query="query"
    :queries="queries"
...
export default defineComponent({
  name: "AdminIntegrationsPagerdutyIndex",
  components: {
    QueriesPage,
  },
  props: {
      ...
      return [
        {
          component: h(VListItem, {
            ...
            density: "compact",
            to: {
              name: "admin-integrations-pagerduty-id-edit",
          ...
          component: h(VListItem, {
            ...
            onClick: async () => {
              ...
              const { status } = await api.delete(
                `/admin/integrations/pagerduty/${customFields[0].id}?${qs.stringify(getCsrfObject())}`,
              );
