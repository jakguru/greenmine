<template>
  <QueriesPage
    :title="$t('pages.admin-integrations-webhooks.title')"
    :params="params"
    :payload="payload"
    :query="query"
    :queries="queries"
...
export default defineComponent({
  name: "AdminIntegrationsWebhooksIndex",
  components: {
    QueriesPage,
  },
  props: {
      ...
      return [
        {
          component: h(VListItem, {
            ...
            density: "compact",
            to: {
              name: "admin-integrations-webhooks-id-edit",
          ...
          component: h(VListItem, {
            ...
            onClick: async () => {
              ...
              const { status } = await api.delete(
                `/admin/integrations/webhooks/${customFields[0].id}?${qs.stringify(getCsrfObject())}`,
              );
