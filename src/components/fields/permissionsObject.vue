...
export default defineComponent({
  ...
  props: {
    ...
    modelValue: {
      type: Object as PropType<Record<string, "0" | "1">>,
      default: () => ({}),
    },
    name: {
      type: String as PropType<string | undefined>,
  ...
  emits: {
    "update:modelValue": (val: Record<string, "0" | "1">) =>
      "object" === typeof val && null !== val,
    "update:model-value": (val: Record<string, "0" | "1">) =>
      "object" === typeof val && null !== val,
    update: (val: Record<string, "0" | "1">) =>
      "object" === typeof val && null !== val,
  },
  setup(props, { emit }) {
    ...
    const value = ref<Record<string, "0" | "1">>(props.modelValue);
    watch(
      () => props.modelValue,
      (is, was) => {
    ...
    const disabledPermissions = computed(() =>
      Object.assign(
        {},
        ...[...keys.value].map((perm) => ({
          [perm]: !model.value.permissions.includes(perm),
        })),
      ),
    );
    return {
